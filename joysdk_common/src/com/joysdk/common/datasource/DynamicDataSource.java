 ...
 * 目前实现功能
 *   一写库多读库选择功能，请参考
 *      @see DynamicDataSourceHolder.sunxc.common.datasource.ReadWriteDataSourceChoice
        @see DynamicDataSourceHolder.sunxc.common.datasource.ReadWriteDataSourceChoice.DataSourceType
 *   
 *   默认按顺序轮询使用读库
 *   默认选择写库
 *   
